...
\newpage		
	...
	\vspace{0.1in}
	\textit{Figure 1}: Database table of the marks header \\
	\vspace{0.2in}
	\includegraphics[scale=0.6]{media/mark.png} \\
	\vspace{0.1in}
	\textit{Figure 2}: Database table of students marks \\
	\end{center}
...
\vspace{0.1in}
\textit{Figure 3}: Instructor's interface for uploading the CSV file\\
\vspace{0.2in}
\includegraphics[scale=0.4]{media/Smarks.png} \\
\vspace{0.1in}
\textit{Figure 4}: Student's interface for viewing his/her marks \\
\end{center}
